...
! function(t, e, i) {
  ...
  L.drawVersion = "0.4.13", L.Draw = {}, L.drawLocal = {
      ...
      initialize: function(t:any, e:any) {
      ...
      _fireCreatedEvent: function(t:any) {
        this._map.fire(L.Draw.Event.CREATED, {
          layer: t,
          layerType: this.type
        })
      },
      _cancelDrawing: function(t:any) {
      ...
      _vertexChanged: function(t:any, e:any) {
      ...
      _startPoint: function(t:any, e:any) {
        this._mouseDownOrigin = L.point(t, e)
      },
      _onMouseUp: function(t:any) {
        var e = t.originalEvent,
          i = e.clientX,
          o = e.clientY;
        this._endPoint.call(this, i, o, t), this._clickHandled = null
      },
      _endPoint: function(e:any, i:any, o:any) {
      ...
      _calculateFinishDistance: function(t:any) {
        var e;
      ...
      _updateGuideColor: function(t:any) {
      ...
      _updateRunningMeasure: function(t:any, e:any) {
